...
def session_csv(session: dict) -> str:
    ...
    writer.writerow({
        ...
        "external_length_cm": session["baseline"]["external_length_cm"],
        "signed_change_cm": "",
        "absolute_change_cm": "",
        "indicator_code": "",
        **settings,
    ...
    for follow_up in session["follow_ups"]:
        writer.writerow({
            ...
            "external_length_cm": follow_up["measurement"][
                "external_length_cm"
            ],
            "signed_change_cm": follow_up["signed_change_cm"],
            "absolute_change_cm": follow_up["absolute_change_cm"],
            "indicator_code": follow_up["research_indicator"]["code"],
            **settings,
        })
