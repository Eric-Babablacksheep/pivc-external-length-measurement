...
class ValidationConfig:
    """Fixed inference and measurement settings for the validation workflow."""
...
def render_validation_overlay(
    ...
    display_scale = max(1.0, 1200.0 / float(source_width))
    ...
    parameters = [cv2.IMWRITE_JPEG_QUALITY, 95] if output_path.suffix.lower() in {".jpg", ".jpeg"} else []
